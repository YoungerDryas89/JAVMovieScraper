...
public class DmmParsingProfile extends SiteParsingProfile implements SpecificProfile {
	...
	@Nonnull
    @Override
	public com.github.youngerdryas89.moviescraper.model.dataitem.Runtime scrapeRuntime() {
		String runtime = "";
		...
		return new com.github.youngerdryas89.moviescraper.model.dataitem.Runtime(runtime);
