...
import com.github.youngerdryas89.scraper.DitzyHeadlessBrowser;
import com.github.youngerdryas89.scraper.DitzyHeadlessBrowserSingle;
	...
	public ArrayList<Actor> scrapeActors() {
		...
		for (Element castElement : castElements) {
			...
			for (Element aliasElement : aliasElements) {
				...
				if (reverseAsianNameInEnglish && Objects.equals(siteLanguageToScrape, englishLanguageCode) && currentAlias.contains(" "))
