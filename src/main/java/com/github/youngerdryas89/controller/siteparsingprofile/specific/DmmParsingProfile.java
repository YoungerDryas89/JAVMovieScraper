...
import com.github.youngerdryas89.controller.languagetranslation.TranslateString;
...
public class DmmParsingProfile extends SiteParsingProfile implements SpecificProfile {
	...
	@Nonnull
    @Override
	public com.github.youngerdryas89.model.dataitem.Runtime scrapeRuntime() {
		String runtime = "";
		...
		return new com.github.youngerdryas89.model.dataitem.Runtime(runtime);
