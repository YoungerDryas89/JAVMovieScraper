...
import com.github.youngerdryas89.model.dataitem.MovieDataItem;
...
public class MovieScrapeResultGroup {
	...
	private ArrayList<?> getPreferredMovieDataItemAsArrayList(Class<?> classOfMovieDataItem) throws SecurityException, IllegalAccessException, IllegalArgumentException {
		...
		System.out.println("Amalgamated " + classOfMovieDataItem.toString().replace("class com.github.youngerdryas89.model.dataitem.", "") + " is " + arrayList);
		return arrayList;
	}
	...
	private MovieDataItem getPreferredMovieDataItemAsMovieDataItem(Class<?> classOfMovieDataItem)
		...
		System.out.println("Amalgamated " + classOfMovieDataItem.toString().replace("class com.github.youngerdryas89.model.dataitem.", "") + " is " + result);
		return result;
	}
