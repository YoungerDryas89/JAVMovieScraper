...
import com.github.youngerdryas89.controller.UtilityFunctions;
import com.github.youngerdryas89.controller.amalgamation.AllAmalgamationOrderingPreferences;
import com.github.youngerdryas89.controller.amalgamation.DataItemSourceAmalgamationPreference;
import com.github.youngerdryas89.controller.amalgamation.ScraperGroupAmalgamationPreference;
import com.github.youngerdryas89.controller.siteparsingprofile.SiteParsingProfile.ScraperGroupName;
import com.github.youngerdryas89.model.dataitem.DataItemSource;
import com.github.youngerdryas89.view.renderer.DataItemSourceRenderer;
import com.github.youngerdryas89.view.renderer.MovieFieldCellRenderer;
...
public class AmalgamationSettingsDialog {
	...
	private void swapElements(final JList<DataItemSource> amalgamationPreferenceList, final DefaultListModel<DataItemSource> amalgamationPreferenceListModel, boolean isOverallPrefSync, int pos1,
	        int pos2) {
	...
	private JButton createUpButton(final JList<DataItemSource> amalgamationPreferenceList, final DefaultListModel<DataItemSource> amalgamationPreferenceListModel, final boolean isOverallPrefSync) {
	...
	private JButton createDownButton(final JList<DataItemSource> amalgamationPreferenceList, final DefaultListModel<DataItemSource> amalgamationPreferenceListModel, final boolean isOverallPrefSync) {
