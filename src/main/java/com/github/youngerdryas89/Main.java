package com.github.youngerdryas89;
...
import com.github.youngerdryas89.controller.Renamer;
import com.github.youngerdryas89.controller.releaserenamer.WebReleaseRenamer;
import com.github.youngerdryas89.controller.siteparsingprofile.SiteParsingProfile;
import com.github.youngerdryas89.controller.siteparsingprofile.specific.ActionJavParsingProfile;
import com.github.youngerdryas89.controller.siteparsingprofile.specific.AvEntertainmentParsingProfile;
import com.github.youngerdryas89.controller.siteparsingprofile.specific.CaribbeancomParsingProfile;
import com.github.youngerdryas89.controller.siteparsingprofile.specific.CaribbeancomPremiumParsingProfile;
import com.github.youngerdryas89.controller.siteparsingprofile.specific.Data18MovieParsingProfile;
import com.github.youngerdryas89.controller.siteparsingprofile.specific.Data18WebContentParsingProfile;
import com.github.youngerdryas89.controller.siteparsingprofile.specific.DmmParsingProfile;
import com.github.youngerdryas89.controller.siteparsingprofile.specific.ExcaliburFilmsParsingProfile;
import com.github.youngerdryas89.controller.siteparsingprofile.specific.HeyzoParsingProfile;
import com.github.youngerdryas89.controller.siteparsingprofile.specific.IAFDParsingProfile;
import com.github.youngerdryas89.controller.siteparsingprofile.specific.JavBusParsingProfile;
import com.github.youngerdryas89.controller.siteparsingprofile.specific.JavLibraryParsingProfile;
import com.github.youngerdryas89.controller.siteparsingprofile.specific.Kin8tengokuParsingProfile;
import com.github.youngerdryas89.controller.siteparsingprofile.specific.MyTokyoHotParsingProfile;
import com.github.youngerdryas89.controller.siteparsingprofile.specific.OnePondoParsingProfile;
import com.github.youngerdryas89.controller.siteparsingprofile.specific.TheMovieDatabaseParsingProfile;
		...
		if (args == null || args.length == 0) {
			...
			Option scrape = OptionBuilder.withArgName("ScraperName FilePath").hasArgs(2)
			        .withDescription("Scrapes and writes metadata of the file located at <FilePath> with type of scraper specified by <ScraperName>.\n" + "Valid ScraperNames are: \n"
			                + "data18webcontent, data18, excaliburfilms, themoviedatabase, iafd, dmm, 1000giri, 1pondo, aventertainment, caribbeancom, caribbeancompremium, heyzo, kin8tengoku, mytokyohot, tokyohot, javbus, javlibrary, actionjav.\n"
