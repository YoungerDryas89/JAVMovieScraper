...
public class MissAVParsingProfileTest {
    static com.github.youngerdryas89.controller.siteparsingprofile.specific.MissAVParsingProfile parser;

    @BeforeClass
    public static void initialize() throws IOException {
        parser = new com.github.youngerdryas89.controller.siteparsingprofile.specific.MissAVParsingProfile();
